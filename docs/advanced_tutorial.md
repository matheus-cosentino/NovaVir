...
This page gathers the main options for tuning preprocessing with fastp and choosing the contig assembler in DeepVir.
...
```bash
bash DeepVir.sh --input <DIR> --output <DIR> --profile local --diamond --darkmatter
```
